...
#                counter_font_path='.\fonts\THSarabun.TTF',

#               # counter_font_path='https://github.com/thanawat1415/BlazePose-Model/raw/main/Roboto-Regular.ttf',
...
#       print("self._counter_font_path")
#       # font_requestr = requests.Session()
#       # font_requestr.mount(self._counter_font_path, auth=('thanawat1415', 'th-116110'))
#       font_request = ImageFont.load(self._counter_font_path)
...
bootstrap_images_in_folder = '01_arm_stretch_full'
...
# # Align CSVs with filtered images.-----------------------------not remove -------------------->
# bootstrap_helper.align_images_and_csvs(print_removed_items=False)
# bootstrap_helper.print_images_out_statistics()
...
# # Transforms pose landmarks into embedding.------------------------------------------------->>>>>stop 
...
# video_path = 'videos\lunges.mov'
# class_name='pushup_push'
# out_video_path = 'videos\pushups-sample-out-2.mov'
