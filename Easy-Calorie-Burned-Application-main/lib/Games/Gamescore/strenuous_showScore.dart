...
class strenuous_showscore extends StatefulWidget {
  const strenuous_showscore({Key? key}) : super(key: key);

  @override
  _strenuous_showscoreState createState() => _strenuous_showscoreState();
}

class _strenuous_showscoreState extends State<strenuous_showscore> {
  String? uidMe, uid;
  UserModel? userModel;
