...
class PoseDetectorView_lunges_strenuous extends StatefulWidget {
  ...
  const PoseDetectorView_lunges_strenuous({
...
class _PoseDetectorViewState extends State<PoseDetectorView_lunges_strenuous> {
