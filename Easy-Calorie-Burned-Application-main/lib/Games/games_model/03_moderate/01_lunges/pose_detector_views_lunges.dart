...
class PoseDetectorView_lunges_moderate extends StatefulWidget {
  ...
  const PoseDetectorView_lunges_moderate({
...
class _PoseDetectorViewState extends State<PoseDetectorView_lunges_moderate> {
