...
import 'package:google_ml_kit_standing_twist/google_ml_kit.dart';
...
class PoseDetectorView_standing_twist extends StatefulWidget {
...
class _PoseDetectorViewState extends State<PoseDetectorView_standing_twist> {
    ...
    while (_running) {
      ...
      if (playTime >= 15) {
        // if (true) {
          ...
          print(
              "##############sum02 setstep${widget.setStep}, sumscore= $_sumScore, sumtime =$playTime, timeset = $timeSum, scoreset= $a_sumScore, poseReps= $poseReps");
