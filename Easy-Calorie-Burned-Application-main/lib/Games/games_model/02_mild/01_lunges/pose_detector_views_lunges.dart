...
import 'package:google_ml_kit_lunges/google_ml_kit.dart';
...
class PoseDetectorView_lunges_mild extends StatefulWidget {
...
class _PoseDetectorViewState extends State<PoseDetectorView_lunges_mild> {
    ...
    while (_running) {
      ...
      if (playTime >= 15) {
        ...
        // if (true) {
          ...
          print(
              "##############sum01 setstep${widget.setStep}, sumscore= $_sumScore, sumtime =$playTime, timeset = $timeSum, scoreset= $a_sumScore, poseReps= $poseReps");
  ...
  Future<void> processImage(
    ...
    if (useClassifier) {
      poses.forEach((pose) {
        ...
        poseReps = pose.reps;
        print('###counterNAR,$poseName,$poseAccuracy,$poseReps,$playTime');
      });
    }
    ...
    print('###NAR,$poseName,$poseAccuracy,$poseReps,$playTime');
  }
}
